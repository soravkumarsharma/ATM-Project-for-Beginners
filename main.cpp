...
int main() {
  ...
  //                                 cin>>withdraw;
  //                                 if(balance>=withdraw){
  //                                     cout<<"Your amount "<<withdraw<< " is
  //                                     withdrawing."; for(int i=0;i<4;i++){
  //                                         cout<<".";
  //                                         Sleep(1000);
  //                                     }
  //                                     cout<<"\n Successfully Withdraw
  //                                     Amount."<<endl; balance -= withdraw;
  ...
  //                 " + FloatToString(withdraw) + " Rs");
  //                 //                 }
  //                 //                 else{
  //                 //                     cout<<"Not enough balance in your
  //                 accout."<<endl;
  //                 //                 }
  //                 //             }
  //                 //             else{
  ...
  //                 //                 char usrChoice;
  //                 //                 while(1){
  //                 //                     cout<<"Press 1: To Withdraw 500
  //                 Rs."<<endl;
  //                 //                     cout<<"Press 2: To Withdraw 1000
  //                 Rs."<<endl;
  //                 //                     cout<<"Press 3: To Withdraw 5000
  //                 Rs."<<endl;
  //                 //                     cout<<"Press 4: To Withdraw 10,000
  //                 Rs."<<endl;
  //                 //                     cout<<"Press 5: Exit From Fast
  //                 Cash."<<endl;
  //                 //                     usrChoice = getch();
  //                 //                     switch(usrChoice){
  //                 //                         case '1':
  ...
  //                 // account->AddTransaction("Withdrawl: " +
  //                 FloatToString(500) + " Rs");

  //                 //                                         }
  //                 //                                         else{
  //                 //                                             cout<<"Not
  //                 enough balance in your account."<<endl;
  //                 //                                         }
  //                 //                                     }
  //                 //                                     else{
  //                 //                                         cout<<"Invalid
  ...
  //                 //                                             cout<<"Your
  //                 Amount 10,000 Rs. is Withdrawing.";
  //                 //                                             for(int
  //                 i=0;i<4;i++){
  //                 // cout<<".";
  //                 // Sleep(1000);
  ...
  //                 //                 cin>>deposit;
  //                 //                 cout<<"Please wait!! Your amount
  //                 "<<deposit<<" Rs. is depositing.";
  //                 //                 for(int i=0;i<4;i++){
  //                 //                     cout<<".";
  //                 //                     Sleep(1000);
  //                 //                 }
